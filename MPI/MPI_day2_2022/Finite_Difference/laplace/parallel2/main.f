...
c
      ...
      parameter (nx=16,ny=16,np=2,nyp=8)
      integer i, j
      double precision u(0:nx+1,0:nyp+1), unew(0:nx+1,0:nyp+1)
      double precision eps, anormp, anorm
c
      integer ierr, irank, status(MPI_STATUS_SIZE,2), ndest, req(2)
c
      character*8 fname
c-----------------------------------------------------------------------
c  tolerance 
...
c
      call MPI_IRECV (u(1,0),nx,MPI_DOUBLE_PRECISION,
     &               MPI_ANY_SOURCE,MPI_ANY_TAG,
     &               MPI_COMM_WORLD,req(1),ierr)
c
      call MPI_ISEND (u(1,nyp),nx,MPI_DOUBLE_PRECISION,
     &               ndest,irank,MPI_COMM_WORLD,req(2),ierr)
...
c
      call MPI_IRECV (u(1,nyp+1),nx,MPI_DOUBLE_PRECISION,
     &               MPI_ANY_SOURCE,MPI_ANY_TAG,
     &               MPI_COMM_WORLD,req(1),ierr)
c
      call MPI_ISEND (u(1,1),nx,MPI_DOUBLE_PRECISION,
     &               ndest,irank,MPI_COMM_WORLD,req(2),ierr)
